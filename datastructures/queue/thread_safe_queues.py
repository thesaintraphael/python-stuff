...
def parse_args():
    ...
    parser.add_argument("-q", "--queue", choices=QUEUE_TYPES.keys(), default="fifo")
...
class Worker(threading.Thread):
    def __init__(self, spead, buffer):
...
class Producer(Worker):
    def __init__(self, spead, buffer, products):
        super().__init__(spead, buffer)
