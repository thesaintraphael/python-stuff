...
def main() -> None:
    ...
    henry = Employee(name="Henry", id_=12346, contract=henry_contract)
    print(
    ...
    sarah = Employee(
        name="Sarah", id_=47832, contract=sarah_contract, commission=sarah_commission
    )
    print(
...
# Source: https://github.com/ArjanCodes/2021-composition-vs-inheritance/blob/main/with_composition.py
